...
#     features['ERC20 uniq sent addr.1'] = len(set(t['to_address'] for t in sent_tokens))
...
#     features['ERC20 avg time between rec 2 tnx'] = get_avg(get_time_diffs(received_tokens))
